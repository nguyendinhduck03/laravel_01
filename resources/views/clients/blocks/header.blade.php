            ...
            <div class="col-12">
                <div class="main_header d-flex justify-content-between align-items-center">
                    <div class="header_logo">
                        <a class="sticky_none" href="/"><img src="{{asset('assets/client/img/logo/logo.png') }}" alt=""></a>
                    </div>
                    <!--main menu start-->
                    ...
                    <div class="header_account">
                        <ul class="d-flex">
                            ...
                            <li class="header_wishlist"><a href="#"><i class="pe-7s-like"></i></a></li>
                            <li class="shopping_cart"><a href="{{route('cart')}}"><i class="pe-7s-shopbag"></i></a>
                            </li>
                        </ul>
